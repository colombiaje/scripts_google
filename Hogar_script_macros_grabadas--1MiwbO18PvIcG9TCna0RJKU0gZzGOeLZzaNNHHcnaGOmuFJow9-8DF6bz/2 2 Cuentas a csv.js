...
function saveAsCuentasCSV() {
  var ss = SpreadsheetApp.getActiveSpreadsheet(); 
  var sheet = ss.getSheetByName('2 2 cuentas Sheets Balance.csv');
...
// agreguega la extensión ".csv" al nombre del archivo
  ...
  //fileName = "2_2_cuentasSheetsBalance.csv";
  
  fileName = "2 2 cuentas Sheets Balance.csv";
  ...
  ui.alert("Ok cuentas csv en Sheets guardado");
...
function showurl(downloadURL) {
  ...
  app.setTitle("Tus cuentas csv en Sheets está listo!");
